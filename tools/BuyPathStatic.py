...
must_contain("src/ReplicatedStorage/Shared/Configs/VisualAssetConfig.luau", "MoneyCollector = { ModelAssetId = 0", "ATM hero prefer ID")
...
must_contain("src/ServerScriptService/Server/Services/DataService.luau", 'SetAttribute("WE_Build", 71)', "v71 WE_Build=71 DataService")
must_contain("src/ServerScriptService/Server/Services/BaseService.luau", 'SetAttribute("WE_Build", 71)', "v71 WE_Build=71 BaseService")
...
must_contain("src/ServerScriptService/Server/EarlyRemotes.server.luau", 'SetAttribute("WE_Build", 71)', "v71 EarlyRemotes WE_Build")
...
must_contain("src/ReplicatedStorage/Shared/Configs/WorldConfig.luau", "OrphanMode = \"Report\",", "World v2 H1 in Report mode for W1 (roadmap 1.5 #3)")
