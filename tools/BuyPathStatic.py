...
must_contain("src/ReplicatedStorage/Shared/Configs/EconomyConfig.luau", "StartingCash = 25000", "v54 StartingCash 25000 (was v51 10000)")
...
# ── v53 admin cash belt+suspenders (shaunie6 still $0 after v51/v52) ─────────
must_contain("src/ServerScriptService/Server/Services/DataService.luau", "[AdminCash] userId=", "v53 loud [AdminCash] join log")
must_contain("src/ServerScriptService/Server/Services/DataService.luau", "uid == 470626172", "v53 hardcode shaunie6 admin match")
must_contain("src/ServerScriptService/Server/Services/DataService.luau", "EnsureAdminPlaytestCash", "v53 EnsureAdminPlaytestCash still present")
must_contain("src/ServerScriptService/Server/Services/AdminService.luau", 'cmd == "cash" or cmd == "givecash"', "v53 cash/givecash admin cmds")
must_contain("src/ServerScriptService/Server/Services/AdminService.luau", "grantAdminPlaytestCashFloor", "v53 grantAdminPlaytestCashFloor")
must_contain("src/ServerScriptService/Server/Services/AdminService.luau", "player.Chatted", "v53 server Chatted cash recovery")
must_contain("src/ReplicatedStorage/Shared/Configs/AdminConfig.luau", '"cash"', "v53 cash in AdminConfig.Commands")
must_contain("src/ReplicatedStorage/Shared/Configs/AdminConfig.luau", "AdminPlaytestCash = 50_000_000", "v53 AdminPlaytestCash 50M")
must_contain("src/ReplicatedStorage/Shared/Configs/AdminConfig.luau", "470626172", "v53 shaunie6 allowlisted")
must_contain("src/ReplicatedStorage/Shared/Configs/EconomyConfig.luau", "StartingCash = 25000", "v54 StartingCash 25000 (was v53 10000)")
must_contain("src/ServerScriptService/Server/Services/EconomyService.luau", "EnsureAdminPlaytestCash", "v53 Push still ensures admin cash")
must_contain("src/ServerScriptService/Server/Services/BaseService.luau", "CharacterAdded:Connect", "v53 CharacterAdded re-push")
must_not_contain("src/ServerScriptService/Server/Services/DataService.luau", "BaseUpgrades[id] = 5", "v53 must NOT auto-max BaseUpgrades")
must_contain("src/ReplicatedStorage/Shared/Configs/StructureVisualConfig.luau", "PreferMeshWhenAssetIdSet = false", "v53 PreferMesh still OFF")
must_contain("src/ServerScriptService/Server/Modules/StructureKitBuilder.luau", "KIT_GEN = 32", "v53 KIT_GEN stays 32")


# ── v54 universal StartingCash join floor (nobody joins at $0) ───────────────
must_contain("src/ReplicatedStorage/Shared/Configs/EconomyConfig.luau", "StartingCash = 25000", "v54 StartingCash 25000")
must_contain("src/ServerScriptService/Server/Services/DataService.luau", "[StartCash] userId=", "v54 [StartCash] log")
must_contain("src/ServerScriptService/Server/Services/DataService.luau", "applyStartingCashFloor", "v54 applyStartingCashFloor")
must_contain("src/ServerScriptService/Server/Services/DataService.luau", "EnsureStartingCashFloor", "v54 EnsureStartingCashFloor")
must_contain("src/ServerScriptService/Server/Services/EconomyService.luau", "EnsureStartingCashFloor", "v54 Economy Push ensures start cash")
must_contain("src/ServerScriptService/Server/Services/BaseService.luau", "EnsureStartingCashFloor", "v54 BaseService join ensures start cash")
must_contain("src/ServerScriptService/Server/Services/DataService.luau", 'SetAttribute("WE_Build", 54)', "v54 WE_Build=54 attribute")
must_contain("src/ServerScriptService/Server/Services/BaseService.luau", 'SetAttribute("WE_Build", 54)', "v54 BaseService WE_Build=54")
must_contain("src/ServerScriptService/Server/Services/AdminService.luau", "TextChatService", "v54 TextChatService backup")
must_contain("src/ServerScriptService/Server/Services/AdminService.luau", "TextChatCommand", "v54 TextChatCommand /cash")
must_contain("src/ServerScriptService/Server/Services/AdminService.luau", "player.Chatted", "v54 keep Player.Chatted")
must_contain("src/ServerScriptService/Server/Services/EconomyService.luau", 'SetAttribute("WE_Cash"', "v54 WE_Cash push every player")
must_contain("src/ReplicatedStorage/Shared/Configs/AdminConfig.luau", "AdminPlaytestCash = 50_000_000", "v54 AdminPlaytestCash 50M")
must_contain("src/ReplicatedStorage/Shared/Configs/AdminConfig.luau", "470626172", "v54 shaunie6 allowlisted")
must_contain("src/ServerScriptService/Server/Services/DataService.luau", "uid == 470626172", "v54 hardcode shaunie6")
must_not_contain("src/ServerScriptService/Server/Services/DataService.luau", "BaseUpgrades[id] = 5", "v54 must NOT auto-max BaseUpgrades")
must_contain("src/ReplicatedStorage/Shared/Configs/StructureVisualConfig.luau", "PreferMeshWhenAssetIdSet = false", "v54 PreferMesh still OFF")
must_contain("src/ServerScriptService/Server/Modules/StructureKitBuilder.luau", "KIT_GEN = 32", "v54 KIT_GEN stays 32")
